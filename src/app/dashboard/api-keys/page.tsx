...
export default function ApiKeysPage() {
    ...
    const handleGenerateKey = () => {
        ...
        const newKey = {
            id: Date.now(),
            name: newKeyName,
            key: `ak_live_${Math.random().toString(36).substring(7)}...${Math.random().toString(36).substring(7)}`,
            status: "Active",
            created: "Just now",
            lastUsed: "Never"
        };
                ...
                <CardContent className="p-0">
                    <div className="overflow-x-auto">
                        <Table className="min-w-[800px]">
                            ...
                            <TableBody>
                                {keys.map((key) => (
                                    <TableRow key={key.id} className="group hover:bg-muted/20 transition-colors border-b-muted/50 text-start">
                                        ...
                                        <TableCell className="px-6 py-5 text-right">
                                            <Button
                                                ...
                                                onClick={() => { setKeyToDelete(key.id); setIsDeleteDialogOpen(true); }}
                                            >
            ...
            <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <DialogContent>
                    ...
                    <DialogFooter>
                        ...
                        <Button variant="destructive" onClick={handleDeleteKey}>Revoke & Delete</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
        </div>
